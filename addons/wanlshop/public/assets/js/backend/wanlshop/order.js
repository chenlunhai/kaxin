"use strict";
define(["jquery", "bootstrap", "backend", "table", "form", "template"], function(e, t, a, i, r, n) {
    var o = {
        index: function() {
            i.api.init({
                extend: {
            ...
            var t = e("#table");
            n.helper("cdnurl", function(e) {
                return Fast.api.cdnurl(e)
            }), n.helper("Moment", Moment), t.bootstrapTable({
            ...
            }), i.api.bindevent(t), e(document).on("click", ".detail[data-id]", function() {
                a.api.open("wanlshop/order/detail/id/" + e(this).data("id"), __("查看详情"), {
                    area: ["1200px", "780px"]
                })
            }), e(document).on("click", ".comment[data-id]", function() {
                a.api.open("wanlshop/comment/detail/type/1/ids/" + e(this).data("id"), __("查看详情"))
            }), e(document).on("click", ".kuaidisub[data-id]", function() {
